...
export default function Navbar({ darkMode, setDarkMode }) {
  ...
  return (
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4 font-sans">
      <nav className="w-full max-w-[992px] h-[56px] px-6 flex items-center justify-between rounded-full border border-[#D5D8DF]/64 dark:border-slate-800/80 bg-[#F9F9F9]/80 dark:bg-slate-900/80 backdrop-blur-[4px] shadow-sm transition-all duration-300 relative">
